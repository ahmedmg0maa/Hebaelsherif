  ...
  theme: {
    extend: {
      colors: {
        ...
        softWhite: withOpacity('--color-soft-white'),
        'soft-white': withOpacity('--color-soft-white'),
        'warm-beige': withOpacity('--color-warm-beige'),
        sand: withOpacity('--color-sand'),
        taupe: withOpacity('--color-taupe'),
        khaki: withOpacity('--color-khaki'),
        border: withOpacity('--color-border'),
        stone: withOpacity('--color-stone'),
        'soft-sand': withOpacity('--color-soft-sand'),
        petrol: withOpacity('--color-petrol'),
        deepTeal: withOpacity('--color-deep-teal'),
        'deep-teal': withOpacity('--color-deep-teal'),
        tealHover: withOpacity('--color-teal-hover'),
        'teal-hover': withOpacity('--color-teal-hover'),
        aqua: withOpacity('--color-aqua'),
        cobalt: withOpacity('--color-cobalt'),
        olive: withOpacity('--color-olive'),
        'leaf-gray': withOpacity('--color-leaf-gray'),
        gold: withOpacity('--color-gold'),
        antiqueGold: withOpacity('--color-antique-gold'),
        'antique-gold': withOpacity('--color-antique-gold'),
        mutedGold: withOpacity('--color-muted-gold'),
        'muted-gold': withOpacity('--color-muted-gold'),
        burgundy: withOpacity('--color-burgundy'),
        burgundySoft: withOpacity('--color-burgundy-soft'),
        'burgundy-soft': withOpacity('--color-burgundy-soft'),
        'warm-gray': withOpacity('--color-warm-gray'),
        charcoal: withOpacity('--color-charcoal'),
        ink: withOpacity('--color-ink'),
        textSoft: withOpacity('--color-text-soft'),
