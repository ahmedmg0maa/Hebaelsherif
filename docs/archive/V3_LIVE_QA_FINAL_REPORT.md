...
- دروس الكورس لا تُقرأ مباشرة للعامة من Supabase.
...
- ضبط متغيرات Vercel.
- إضافة الدومينات إلى Supabase Auth.
- تنظيف أي بيانات قديمة في Supabase تحتوي روابط خاصة داخل `courses` أو `books`.
