...
- انشر `supabase/migrations` المناسبة قبل تجربة الأدمن على production.
...
- جرب أزرار الطلبات والحجوزات ببيانات حقيقية على مشروع Supabase قبل الإعلان التجاري.
