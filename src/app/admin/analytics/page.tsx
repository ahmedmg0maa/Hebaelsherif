...
import { collection, getDocs } from '@/lib/supabase/data-client-compat'
...
export default function AdminAnalyticsPage() {
  ...
  return (
    <div className="space-y-8">
      <AdminPageHeader title="تحليلات وملخصات صادقة" description="لا توجد أرقام وهمية أو Charts شكلية. كل رقم هنا محسوب من بيانات Supabase الموجودة فعليًا." />
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard label="مصدر البيانات" value="Supabase" hint="بدون بيانات افتراضية" tone="muted" />
      </div>
