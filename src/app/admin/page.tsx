    ...
    <div className="space-y-8">
      <section className="paper-texture relative overflow-hidden admin-hero on-dark rounded-[2.5rem] border p-7 shadow-botanical md:p-9">
        ...
        <div className="relative grid gap-8 xl:grid-cols-[1fr_360px] xl:items-center">
          <div>
            <PremiumBadge variant="gold">مركز القيادة</PremiumBadge>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <PremiumButton href="/admin/bookings" variant="outline" className="border-[#F5F0E7]/60 text-[#F5F0E7] hover:bg-[#F5F0E7] hover:text-[#0F3237]">
                الحجوزات القادمة
              </PremiumButton>
            </div>
          </div>
...
function Signal({ label, value }: { label: string; value: string | number }) {
  return (
    <div className="rounded-2xl border border-[#F5F0E7]/15 bg-[#F5F0E7]/8 px-4 py-3">
