...
import { collection, getDocs, limit, orderBy, query } from '@/lib/supabase/data-client-compat'
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        if (!cancelled) setError('تعذر تحميل بيانات لوحة التشغيل. راجع اتصال Supabase وصلاحيات الأدمن.')
      } finally {
