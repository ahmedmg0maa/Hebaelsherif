...
export default function AdminTasksPage() {
  ...
  async function createTask(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await runAdminAction(sessionUser, { action: 'task_created', targetType: 'admin_tasks', values: form })
  ...
  async function updateTask(task: AdminTask, action: string, confirmMessage: string) {
    ...
    setError('')
    try {
      const updated = (await runAdminAction(sessionUser, { action, targetType: 'admin_tasks', targetId: task.id })) as Record<string, unknown>
