...
export default function AdminActionQueuePage() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        if (!cancelled) setError('تعذر تحميل قائمة المتابعة. راجع صلاحيات الأدمن واتصال Supabase.')
      } finally {
  ...
  return (
    <div className="space-y-8">
      ...
      <AdminPanel title="قائمة الإجراءات" description="لا توجد أرقام أو عناصر وهمية هنا؛ كل عنصر مبني على بيانات Supabase الحالية.">
