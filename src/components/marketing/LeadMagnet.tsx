...
export default function LeadMagnet() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setMessage(email.trim() ? 'تم تسجيل اهتمامك. اربطي النموذج لاحقًا بخدمة البريد المناسبة.' : 'اكتبي بريدك أولًا.')
  ...
  return (
    <form onSubmit={handleSubmit} className="premium-glow-border rounded-[2rem] border border-sand bg-ivory/90 p-6 shadow-premium backdrop-blur-sm">
      ...
      <p className="mt-3 text-sm leading-7 text-warm-gray">مكان جاهز لالتقاط البريد وإرسال lead magnet عند ربط خدمة البريد لاحقًا.</p>
