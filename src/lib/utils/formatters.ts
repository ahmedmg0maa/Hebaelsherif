import type { SupabaseDate } from '@/types'
...
export function formatArabicDate(value: SupabaseDate | string | Date | undefined) {
...
export function formatArabicDateTime(value: SupabaseDate | string | Date | undefined) {
  if (!value) return 'غير محدد'
