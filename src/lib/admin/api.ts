...
import { FieldValue, Timestamp, type DocumentData, type Supabase, type Transaction } from '@/lib/supabase/data-admin-compat'
...
export async function addCustomerTag(db: Supabase, userId: string, tag: string) {
