...
import { FieldValue, Timestamp, type Supabase } from '@/lib/supabase/data-admin-compat'
...
export async function writeAdminLog(db: Supabase, params: LogParams): Promise<void>
export async function writeAdminLog(params: LogParams): Promise<void>
export async function writeAdminLog(dbOrParams: Supabase | LogParams, maybeParams?: LogParams) {
  const db = maybeParams ? (dbOrParams as Supabase) : getAdminDb()
...
export async function createNotification(db: Supabase, params: NotificationParams): Promise<void>
export async function createNotification(params: NotificationParams): Promise<void>
export async function createNotification(dbOrParams: Supabase | NotificationParams, maybeParams?: NotificationParams) {
  const db = maybeParams ? (dbOrParams as Supabase) : getAdminDb()
