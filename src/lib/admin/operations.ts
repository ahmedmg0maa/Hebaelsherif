import type { Booking, Book, Course, SupabaseDate, Order, ProductType } from '@/types'
...
export function asDate(value: SupabaseDate | string | Date | undefined | null) {
...
export function toMillis(value: SupabaseDate | string | Date | undefined | null) {
  return asDate(value)?.getTime() || 0
}

export function isToday(value: SupabaseDate | string | Date | undefined | null) {
